...
void loop() 
{
  if (xbee.available() > 0) 
  {
    ...
    switch(received){
      case '!':
        frame_size = construct_Zigbee_API_frame("BLUE LED ON");
        ...
        break;
      case '@':
        frame_size = construct_Zigbee_API_frame("BLUE LED OFF");
        ...
        break;
      case '#':
        frame_size = construct_Zigbee_API_frame("YELLOW LED ON");
        ...
        break;
      case '$':
        frame_size = construct_Zigbee_API_frame("YELLOW LED OFF");
